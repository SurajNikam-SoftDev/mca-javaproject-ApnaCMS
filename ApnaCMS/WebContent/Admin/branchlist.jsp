...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApnaCMS :: Branch List</title>
	...
	<!--========== HEADER ==========-->
                            ...
                            <div class="nav__dropdown">
								...
								<div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="BranchList" class="nav__dropdown-item active">List</a>
                                    </div>
                                </div>
                            </div>
                            <div class="nav__dropdown">
		...
		<div class="container-fluid table-container" style= "" >
			<div class = "text-right mt-2 mb-2" >
				<a href="javascript:void(0)" onclick="location.href='AddNewBranch'" style = "font-size:12px;font-weight:bolder;border-radius:5px;padding:10px;border:1px solid #007bff;color: #007bff;text-decoration: none;">+ Add New Branch</a>
			</div>
        ...
        <table class="table table-striped table-bordered myDataTable" style = "width: 100%;">
            <thead>
                <tr>
                    ...
                    <th class = "search-col">Branch Code</th>
                    <th class = "search-col">Street/Building</th>
