...
%>
                            ...
                            <div class="nav__dropdown">
								...
								<div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="UnsuccessfullyDelivery" class="nav__dropdown-item active">Unsuccessfully Delivery Attempt</a>
                                    </div>
                                </div>
                            </div>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetParcelListByCategory?status=Unsuccessfully Delivery Attempt";
       // alert(url);
