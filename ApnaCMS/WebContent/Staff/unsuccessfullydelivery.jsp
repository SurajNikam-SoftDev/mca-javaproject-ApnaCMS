...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApnaCMS :: Unsuccessfully Delivered</title>
...
%>
                            ...
                            <div class="nav__dropdown">
								...
								<div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="SP_UnsuccessfullyDelivery" class="nav__dropdown-item active">Unsuccessfully Delivery Attempt</a>
                                    </div>
                                </div>
                            </div>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetSPParcelListByCategory?status=Unsuccessfully Delivery Attempt";
       // alert(url);
