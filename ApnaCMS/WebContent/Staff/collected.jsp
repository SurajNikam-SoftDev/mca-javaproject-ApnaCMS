...
%>
                            ...
                            <div class="nav__dropdown">
								...
								<div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="SP_Collected" class="nav__dropdown-item active">Collected</a>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetSPParcelListByCategory?status=Item Accepted by Courier";
       // alert(url);
