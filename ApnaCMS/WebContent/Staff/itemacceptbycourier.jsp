...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApnaCMS :: Item Accept By Courier</title>
...
%>
                            ...
                            <div class="nav__dropdown">
								...
								<div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="SP_ItemAcceptByCourier" class="nav__dropdown-item active">Item Accepted by courier</a>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetSPParcelListByCategory?status=PreApproval From CMS";
       // alert(url);
