...
<head>
    ...
    <meta http-equiv='X-UA-Compatible' content='IE=edge'>
   	<title>ApnaCMS :: Arrived At Destination</title>
...
%>
                            ...
                            <div class="nav__dropdown">
								...
								<div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        ...
                                        <a href="SP_ArrivedAtDestination" class="nav__dropdown-item active">Arrived At Destination</a>
    ...
    function loadXMLDoc() {
        ...
        var url = "GetSPParcelListByCategory?status=In-Transit";
       // alert(url);
